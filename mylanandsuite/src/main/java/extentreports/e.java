...
public class e {
	//step1: adding essential dependencies
	// create an object or extent report class
	// pass path where u want to get result 
	...
	report = new ExtentReports("C:\\Users\\hp\\eclipse-workspace\\mylanandsuite\\src\\main\\java\\extentreports\\m.html");
	// test start ,finish, loging
	test = report.startTest("e");
